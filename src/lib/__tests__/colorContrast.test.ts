 ...
 *
 * The route planner uses text-muted for:
 *   - Section headings ("Route", "Your Truck", "Settings", "Choose Your Route")
 *   - Descriptive paragraph ("We found N routes")
 *   - Hint text ("Select a truck above to continue")
 *
 * All are normal-weight at small sizes → require 4.5:1 contrast ratio.
 */
