  ...
  return (
    <main id="main-content" className="flex flex-1 flex-col items-center bg-background px-4 py-12">
      <div className="w-full max-w-lg">
        ...
        <h1 className="text-2xl font-bold text-text-primary mb-1">Terms of Service</h1>
        <p className="text-sm text-text-secondary mb-8">Effective date: March 11, 2026 · Last updated: March 11, 2026</p>

        <div className="space-y-8 text-text-secondary">

          <section aria-labelledby="section-no-affiliation">
            <h2 id="section-no-affiliation" className="text-lg font-semibold text-text-primary mb-2">1. No Affiliation</h2>
          ...
          <section aria-labelledby="section-estimates-only">
            <h2 id="section-estimates-only" className="text-lg font-semibold text-text-primary mb-2">2. Estimates Only — Not a Guarantee</h2>
            <p className="text-sm leading-relaxed">
            ...
            <ul className="mt-2 space-y-1 text-sm text-text-secondary list-disc list-inside leading-relaxed">
          ...
          <section aria-labelledby="section-no-liability">
            <h2 id="section-no-liability" className="text-lg font-semibold text-text-primary mb-2">3. No Liability</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section aria-labelledby="section-no-warranty">
            <h2 id="section-no-warranty" className="text-lg font-semibold text-text-primary mb-2">4. No Warranty</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section aria-labelledby="section-limitation-of-liability">
            <h2 id="section-limitation-of-liability" className="text-lg font-semibold text-text-primary mb-2">5. Limitation of Liability</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section aria-labelledby="section-ip">
            <h2 id="section-ip" className="text-lg font-semibold text-text-primary mb-2">6. Intellectual Property</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section aria-labelledby="section-changes">
            <h2 id="section-changes" className="text-lg font-semibold text-text-primary mb-2">7. Changes to These Terms</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section aria-labelledby="section-governing-law">
            <h2 id="section-governing-law" className="text-lg font-semibold text-text-primary mb-2">8. Governing Law</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section aria-labelledby="section-contact">
            <h2 id="section-contact" className="text-lg font-semibold text-text-primary mb-2">9. Contact</h2>
            <p className="text-sm leading-relaxed">
              For legal inquiries, please contact:{" "}
              <a href="mailto:getfillright@gmail.com" className="text-text-secondary underline underline-offset-2 hover:text-accent transition-colors">getfillright@gmail.com</a>
            </p>
          </section>
